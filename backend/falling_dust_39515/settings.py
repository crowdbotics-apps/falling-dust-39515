"""
Django settings for falling_dust_39515 project.
...
ROOT_URLCONF = 'falling_dust_39515.urls'
...
WSGI_APPLICATION = 'falling_dust_39515.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_dust_39515 API",
    "DESCRIPTION": "API documentation for falling_dust_39515 App",
    "VERSION": "v1",
}
